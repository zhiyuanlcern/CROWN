//Code generated automatically by TMVA for Inference of Model file [et_even_lowmass.h5] at [Fri Nov 24 04:37:47 2023] 

#ifndef TMVA_SOFIE_ET_EVEN_LOWMASS
#define TMVA_SOFIE_ET_EVEN_LOWMASS
...
namespace TMVA_SOFIE_et_even_lowmass{
namespace BLAS{
...
Session(std::string filename ="") {
   if (filename.empty()) filename = "data/pnn/et_even_lowmass.dat";
   std::ifstream f;
   f.open(filename);
   if (!f.is_open()){
...
} //TMVA_SOFIE_et_even_lowmass

#endif  // TMVA_SOFIE_ET_EVEN_LOWMASS
