//Code generated automatically by TMVA for Inference of Model file [tt_odd_lowmass.h5] at [Fri Nov 24 04:37:41 2023] 

#ifndef TMVA_SOFIE_TT_ODD_LOWMASS
#define TMVA_SOFIE_TT_ODD_LOWMASS
...
namespace TMVA_SOFIE_tt_odd_lowmass{
namespace BLAS{
...
Session(std::string filename ="") {
   if (filename.empty()) filename = "data/pnn/tt_odd_lowmass.dat";
   std::ifstream f;
   f.open(filename);
   if (!f.is_open()){
...
} //TMVA_SOFIE_tt_odd_lowmass

#endif  // TMVA_SOFIE_TT_ODD_LOWMASS
