//Code generated automatically by TMVA for Inference of Model file [tt_even_lowmass.h5] at [Fri Nov 24 04:37:24 2023] 
...
Session(std::string filename ="") {
   if (filename.empty()) filename = "data/pnn/tt_even_lowmass.dat";
   std::ifstream f;
   f.open(filename);
   if (!f.is_open()){
