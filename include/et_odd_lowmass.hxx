//Code generated automatically by TMVA for Inference of Model file [et_odd_lowmass.h5] at [Fri Nov 24 04:37:53 2023] 

#ifndef TMVA_SOFIE_ET_ODD_LOWMASS
#define TMVA_SOFIE_ET_ODD_LOWMASS
...
namespace TMVA_SOFIE_et_odd_lowmass{
namespace BLAS{
...
Session(std::string filename ="") {
   if (filename.empty()) filename = "data/pnn/et_odd_lowmass.dat";
   std::ifstream f;
   f.open(filename);
   if (!f.is_open()){
...
std::vector<float> infer(float* tensor_input1){
   std::cout << "Odd model Input Vector: ";
...
} //TMVA_SOFIE_et_odd_lowmass

#endif  // TMVA_SOFIE_ET_ODD_LOWMASS
